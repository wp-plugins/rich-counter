...
Download: http://soft.saschart.com/download/rich_counter_wp_1.0.5.zip
...
global $wpdb, $rich_counter_prefix, $rich_counter_version;
...
require_once WP_PLUGIN_DIR_.'/includes/functions.php';
$saschart=new RichCounter();
require_once WP_PLUGIN_DIR_.'/includes/admin.php';
require_once WP_PLUGIN_DIR_.'/includes/mysql_install.php';
...
if ($counter_robot) {
  if ($count_robots)
    require_once WP_PLUGIN_DIR_.'/index.php';
}
else {
  ...
  if (!$counter_browser) {
    ...
    $url=WP_PLUGIN_URL_."/index.php?counter_page=".urlencode($counter_page)."&counter_ref=".urlencode($counter_ref);
