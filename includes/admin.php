  ...
  while ($row = mysql_fetch_row ($result)) {
    ...
    if ($row[1]) {
      ...
      if (!is_file("$counter_imgs".$browser."_".str_replace(" ","_",strtolower($row[1])).".gif"))
        $row[1]="<div style=\"float:left;width:80px\"><b>Browser:</b> </div><div align=\"left\" class=\"bottom_line\"><img src=\"".$counter_src.$browser."_other.gif\" alt=\"$g_site_name\">$g_n".strip_tags($row[1])."</div>";
      else
        $row[1]="<div style=\"float:left;width:80px\"><b>Browser:</b> </div><div align=\"left\" class=\"bottom_line\"><img src=\"".$counter_src.$browser."_".str_replace(" ","_",strtolower($row[1])).".gif\" alt=\"$g_site_name\">$g_n".strip_tags($row[1])."</div>";
    }
    if ($row[2])
